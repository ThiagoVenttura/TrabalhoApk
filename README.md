...
Entender o funcionamento básico de um PWA

Utilizar arquivos de mídia (imagens e músicas)

Aprender organização de arquivos em um projeto real
...
Suporte básico a funcionamento offline
...
Noções iniciais de Progressive Web Apps
